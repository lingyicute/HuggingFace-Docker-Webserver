...
RUN git clone https://github.com/lingyicute/Me && rm -rf ./Me/.git && wget https://raw.githubusercontent.com/lingyicute/HuggingFace-Docker-Webserver/main/start.sh && chmod +x /home/lingyicute/start.sh
